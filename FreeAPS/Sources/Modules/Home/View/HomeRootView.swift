                        ...
                        LinearGradient(
                            gradient: Gradient(
                                stops: colorScheme == .light
                                    ? [
                                        .init(color: Color.green.opacity(0.2), location: 0.0),
                                    ...
                                    : [
                                        .init(color: Color.teal.opacity(0.45), location: 0.0),
                                        .init(color: Color.black, location: 0.45), // Snelle overgang naar zwart aan de bovenkant
                                        .init(color: Color.black, location: 0.70), // Zwart blijft tot 70%
                                        .init(color: Color.teal.opacity(0.45), location: 1.0)
                                    ]
                            ),
                            startPoint: .top,
                            endPoint: .bottom
